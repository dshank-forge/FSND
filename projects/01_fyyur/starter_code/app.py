...
class Show(db.Model):
    ...
    datetime = db.Column(db.DateTime) #datetime 
    image_link = db.Column(db.String(500), db.ForeignKey('Artist.image_link'), nullable=True) 
...
def create_venue_submission():
  ...
  new_venue = Venue(name=description)
